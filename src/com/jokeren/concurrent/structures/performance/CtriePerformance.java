...
import com.jokeren.concurrent.structures.ctrie.ThreadLoopTime;
...
public class CtriePerformance {
    ...
    public static void main(String args[]) {
        CtriePerformance ctriePerformance = new CtriePerformance();
        //parse
        ...
        for (int i = 0; i < 8; ++i) {
            ctriePerformance.run();
        }
    }

    public void run() {
        ConcurrentHashTrie<Long, Object> concurrentHashTrie = new ConcurrentHashTrie<>(2);
        ...
        for (int i = 0; i < nThread; ++i) {
            ...
            threads[i] = new ThreadLoopTime(threadId, keySets, insert, remove, contain, move,
                    nonUniform, range, gate, concurrentHashTrie);
        }
